...
The interface runs on the same port as the JSON-RPC interface, by default port 34229 for mainnet, port 17978 for testnet,
and port 17798 for regtest.
...
Example:
```
$ curl localhost:17978/rest/getutxos/checkmempool/b2cdfd7b89def827ff8af7cd9bff7627ff72e5e8b0f71210f92ea7a4000c5d75-0.json 2>/dev/null | json_pp
{
   "chainHeight" : 325347,
